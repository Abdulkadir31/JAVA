...
class gameplaymp extends JPanel implements KeyListener,ActionListener {
	...
	public void paint(Graphics g)
	{
		...
		if(ballposx<=-20) 
		{
			...
			g.drawString("PLAYER 2 WINS", 270,290);
			g.drawString("PRESS ENTER TO CONTINUE", 200,320);
			g.drawString("ESC TO  QUIT	",280,350);
		}
